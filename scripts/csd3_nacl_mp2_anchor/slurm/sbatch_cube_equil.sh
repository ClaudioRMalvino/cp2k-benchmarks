...
# NVT equilibration of one cubic anchor cell (210k steps = 30 ps settle + 5
# snapshots 15 ps apart). Usage: sbatch sbatch_cube_equil.sh cube2|cube3 [fist_ranks]
# Checkpoint-safe: resubmit the same command after a wall kill to continue.
set -euo pipefail
