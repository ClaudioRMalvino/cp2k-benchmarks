...
# Build upstream/master from scratch (ensures same compiler flags as optimized branch)
cd /home/raid/crm98/cp2k-benchmarks/cp2k_master/
./build_cp2k.sh
cp /local/data/public/crm98/cp2k-buildtree/install/bin/cp2k.psmp ~/cp2k_binaries/phy-cerberus/cp2k_master.psmp

# Rebuild optimized branch with latest changes
