...
if [ "$TARGET_BRANCH" == "optimized" ]; then
    ...
    OUTDIR="/home/raid/crm98/cp2k-benchmarks/results/cp2k_optimized/NNP/NNP_core_scaling_${LABEL}_${TIMESTAMP}"
    ...
    OUTDIR="/home/raid/crm98/cp2k-benchmarks/results/cp2k_master/NNP/NNP_core_scaling_${LABEL}_${TIMESTAMP}"
